...
{
    const uint16_t mapped_angle = CONFIG_SERVO_MIN_BASE + CONFIG_SERVO_MAP_SLOPE * (angle - CONFIG_SERVO_MIN_ANGLE);
    // Some mapping shenanigans. Numbers picked by experiment.
